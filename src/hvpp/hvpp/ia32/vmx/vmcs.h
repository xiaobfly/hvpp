...
namespace ia32::vmx
{
    namespace detail
    {
        ...
        {
            return
                width == detail::vmcs_width_t::_16_bit
                    ? 2
                    : width == detail::vmcs_width_t::_64_bit
                    ? 8
                    : width == detail::vmcs_width_t::_32_bit
                    ? 4
                    : width == detail::vmcs_width_t::natural
                    ? 8
                    : -1;
        }

        static constexpr uint16_t encode(vmcs_access_type_t access_type, vmcs_type_t type, vmcs_width_t width,
        ...
        static constexpr void decode(uint16_t field, vmcs_access_type_t& access_type, vmcs_type_t& type,
                                     vmcs_width_t& width, uint16_t& index) noexcept
        {
    ...
    public:
        enum class field
        {
            ...
            ctrl_secondary_processor_based_vm_execution_controls = detail::encode_full(
                type::control, width::_32_bit, 15),
    ...
    inline vmcs_t::field& operator+=(vmcs_t::field& vmcs_field, int index) noexcept
    {
        reinterpret_cast<int&>(vmcs_field) += index;
        return vmcs_field;
    }
    ...
    constexpr inline const char* to_string(vmcs_t::field value) noexcept
    {
        ...
        case vmcs_t::field::ctrl_posted_interrupt_notification_vector: return
                "ctrl_posted_interrupt_notification_vector";
        ...
        case vmcs_t::field::ctrl_virtualization_exception_info_address: return
                "ctrl_virtualization_exception_info_address";
        ...
        case vmcs_t::field::ctrl_processor_based_vm_execution_controls: return
                "ctrl_processor_based_vm_execution_controls";
        ...
        case vmcs_t::field::ctrl_secondary_processor_based_vm_execution_controls: return
                "ctrl_secondary_processor_based_vm_execution_controls";
