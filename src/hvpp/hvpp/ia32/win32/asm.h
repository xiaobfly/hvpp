...
uint64_t ia32_asm_vmx_vmcall_ex(uint64_t rcx, uint64_t rdx, uint64_t r8, uint64_t r9, uint64_t r10, uint64_t r11,
                                uint64_t r12, uint64_t r13, uint64_t r14, uint64_t r15) noexcept;
