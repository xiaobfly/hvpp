...
namespace hvpp
{
    ...
    public:
        ...
        auto guest_write_memory(va_t guest_va, const void* buffer, size_t size,
                                bool ignore_errors = false) noexcept -> va_t;
    ...
    public:
        ...
        {
            interrupt_queue_external,
            // vmx::interrupt_type::external (0)
            interrupt_queue_nmi,
            // vmx::interrupt_type::nmi (2)
