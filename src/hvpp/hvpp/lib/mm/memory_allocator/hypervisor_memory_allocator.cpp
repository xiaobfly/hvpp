...
namespace mm
{
    ...
    auto hypervisor_memory_allocator::attach(void* address, size_t size) noexcept -> error_code_t
    {
        ...
        hvpp_assert(
            reinterpret_cast<uintptr_t>(page_bitmap_buffer) == reinterpret_cast<uintptr_t>(page_bitmap_buffer_tmp));
        hvpp_assert(
            reinterpret_cast<uintptr_t>(page_allocation_map_) == reinterpret_cast<uintptr_t>(page_allocation_map_tmp));
