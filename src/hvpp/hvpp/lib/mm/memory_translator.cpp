...
namespace mm
{
    ...
    va_t memory_translator::read(va_t va, cr3_t cr3, void* buffer, size_t size,
                                 bool ignore_errors /* = false */) noexcept
    {
        return read_write(va, cr3, buffer, size, false, ignore_errors);
    }

    va_t memory_translator::write(va_t va, cr3_t cr3, const void* buffer, size_t size,
                                  bool ignore_errors /* = false */) noexcept
    {
    ...
    va_t memory_translator::read_write(va_t va, cr3_t cr3, void* buffer, size_t size, bool write,
                                       bool ignore_errors) noexcept
    {
