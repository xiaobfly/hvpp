...
namespace logger
{
    ...
    auto initialize() noexcept -> error_code_t { return detail::initialize(); }
    ...
    auto get_options() noexcept -> options_t { return current_options; }
    ...
    auto get_level() noexcept -> level_t { return current_level; }
